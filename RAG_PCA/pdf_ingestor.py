...
def create_bge_embedding_function(
...
def ingest_all_pdfs_to_chromadb(
    pdf_directory: str = "pca_documents", collection_name: str = "pca_documents"
):
    """
    ...
    embedding_function = create_bge_embedding_function("BAAI/bge-small-en-v1.5")
    ...
    for pdf_path in pdf_files:
        ...
        for page_num, page_text in pages_text:
            ...
            metadatas = [
                {"source": filename, "page_number": page_num, "chunk_index": i}
...
def query_collection(
    query_text: str, collection_name: str = "pca_documents", n_results: int = 5
):
    """
